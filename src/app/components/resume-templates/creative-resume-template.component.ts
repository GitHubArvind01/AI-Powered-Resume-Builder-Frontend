...
@Component({
  ...
  template: '<app-shared-resume-template [resume]="resume" [editable]="editable" [mode]="mode" variant="creative" (resumeChange)="resumeChange.emit($event)"></app-shared-resume-template>'
})
