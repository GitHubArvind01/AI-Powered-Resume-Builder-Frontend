...
@Component({
  ...
  template: '<app-shared-resume-template [resume]="resume" [editable]="editable" [mode]="mode" variant="modern" (resumeChange)="resumeChange.emit($event)"></app-shared-resume-template>'
})
