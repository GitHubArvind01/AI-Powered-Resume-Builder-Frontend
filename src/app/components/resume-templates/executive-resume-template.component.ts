...
@Component({
  ...
  template: '<app-shared-resume-template [resume]="resume" [editable]="editable" [mode]="mode" variant="executive" (resumeChange)="resumeChange.emit($event)"></app-shared-resume-template>'
})
