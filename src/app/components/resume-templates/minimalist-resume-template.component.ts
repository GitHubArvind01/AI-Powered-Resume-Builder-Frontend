...
@Component({
  selector: 'app-minimalist-resume-template',
  standalone: true,
  imports: [SharedResumeTemplateComponent],
  template: '<app-shared-resume-template [resume]="resume" [editable]="editable" [mode]="mode" variant="minimalist" (resumeChange)="resumeChange.emit($event)"></app-shared-resume-template>'
})
export class MinimalistResumeTemplateComponent {
