...
@Component({
  ...
  template: '<app-shared-resume-template [resume]="resume" [editable]="editable" variant="minimalist" (resumeChange)="resumeChange.emit($event)"></app-shared-resume-template>'
})
