...
@Component({
  ...
  template: '<app-shared-resume-template [resume]="resume" [editable]="editable" variant="professional" (resumeChange)="resumeChange.emit($event)"></app-shared-resume-template>'
})
